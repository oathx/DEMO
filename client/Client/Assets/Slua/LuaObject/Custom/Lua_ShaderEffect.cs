...
public class Lua_ShaderEffect : LuaObject {
	...
	static public int Dissolve_s(IntPtr l) {
		try {
			...
			var ret=ShaderEffect.Dissolve(a1,a2,a3,a4,a5,a6);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int NormalDissolve_s(IntPtr l) {
		try {
			...
			var ret=ShaderEffect.NormalDissolve(a1,a2,a3,a4,a5);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"ShaderEffect");
		addMember(l,Dissolve_s);
		addMember(l,NormalDissolve_s);
		createTypeMetatable(l,constructor, typeof(ShaderEffect));
	}
}
