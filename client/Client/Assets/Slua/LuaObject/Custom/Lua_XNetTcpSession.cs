...
public class Lua_XNetTcpSession : LuaObject {
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int constructor(IntPtr l) {
		try {
			XNetTcpSession o;
			o=new XNetTcpSession();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int Connect(IntPtr l) {
		try {
			XNetTcpSession self=(XNetTcpSession)checkSelf(l);
			System.String a1;
	...
	static public void reg(IntPtr l) {
		...
		createTypeMetatable(l,constructor, typeof(XNetTcpSession),typeof(INetSession));
	}
}
