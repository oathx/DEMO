...
function Start(self)
	...
	self:RegisterClickEvent(UL_ACCOUNT, OnAccountClicked)
end
...
function OnAccountClicked(self, goSend, evtData)
    local evtArgs = {
    }
    PluginManager.GetSingleton():FireEvent(GuiEvent.EVT_ACCOUNT, evtArgs)
end