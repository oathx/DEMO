...
public class Lua_XNetLuaPacket : LuaObject {
	...
	static public int Type(IntPtr l) {
		try {
			XNetLuaPacket self=(XNetLuaPacket)checkSelf(l);
			var ret=self.Type();
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,XNetLuaPacket.ReadBlock,true);
		addMember(l,XNetLuaPacket.WriteBlock,true);
		createTypeMetatable(l,constructor, typeof(XNetLuaPacket));
	}
}
