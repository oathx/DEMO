...
public class Lua_XPrefs : LuaObject {
	...
	static public int GetString_s(IntPtr l) {
		try {
			...
			System.String a2;
			checkType(l,2,out a2);
			var ret=XPrefs.GetString(a1,a2);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,Load_s);
		addMember(l,Save_s);
		createTypeMetatable(l,constructor, typeof(XPrefs));
	}
}
